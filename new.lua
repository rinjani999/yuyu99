...
local function GenerateKeyboard()
	...
	space:FindFirstChild("TextLabel").Text = "SPACE"
end
GenerateKeyboard()
...
WBCloseBtn.TextSize = 16
WBCloseBtn.TextColor3 = Color3.fromRGB(255, 100, 100)
WBCloseBtn.Size = UDim2.new(0, 40, 0, 40)
WBCloseBtn.Position = UDim2.new(1, -40, 0, 0)
...
WBScroll.Size = UDim2.new(1, -20, 1, -90)
WBScroll.Position = UDim2.new(0, 10, 0, 50)
WBScroll.BackgroundTransparency = 1
WBScroll.ScrollBarThickness = 3
...
WBListLayout.Padding = UDim.new(0, 4)
...
WBSearchBox.Position = UDim2.new(0, 10, 0, 45)
Instance.new("UICorner", WBSearchBox).CornerRadius = UDim.new(0, 4)
SetupPhantomBox(WBSearchBox, "Search all words...")
...
local function RefreshWordBrowser()
	...
	local query = (queryRaw == "Search all words...") and "" or queryRaw:lower():gsub("[%s%c]+", "")
	local shownCount = 0
	for _, w in ipairs(Words) do
		if query == "" or w:find(query, 1, true) then
			shownCount = shownCount + 1
