...
BlatantAutoThreshold = 5,
EmergencyErrorRate = 0,
EmergencyCPM = 1100
}
...
local blatantAutoThreshold = Config.BlatantAutoThreshold
local emergencyErrorRate = Config.EmergencyErrorRate
local emergencyCPM = Config.EmergencyCPM
...
BlatantThresholdLabel.Text = "Blatant Threshold: " .. blatantAutoThreshold .. "s"
...
BlatantThresholdLabel.Position = UDim2.new(0, 15, 0, 90)
...
BlatantThresholdBg.Position = UDim2.new(0, 15, 0, 110)
...
BlatantThresholdFill.Size = UDim2.new(blatantAutoThreshold/14, 0, 1, 0)
...
blatantAutoThreshold = math.floor(pct * 14)
...
local ResetUsedWordsBtn = Instance.new("TextButton", TogglesFrame)
ResetUsedWordsBtn.Text = "Reset Used Words"
ResetUsedWordsBtn.Font = Enum.Font.GothamMedium
ResetUsedWordsBtn.TextSize = 11
ResetUsedWordsBtn.TextColor3 = Color3.fromRGB(255, 150, 100)
ResetUsedWordsBtn.BackgroundColor3 = THEME.Background
ResetUsedWordsBtn.Size = UDim2.new(0, 130, 0, 24)
ResetUsedWordsBtn.Position = UDim2.new(0, 150, 0, 145)
Instance.new("UICorner", ResetUsedWordsBtn).CornerRadius = UDim.new(0, 4)
ResetUsedWordsBtn.MouseButton1Click:Connect(function()
UsedWords = {}
Blacklist = {}
ShowToast("UsedWords & Blacklist cleared!", "success")
...
if useHumanization and seconds and seconds <= blatantAutoThreshold then
errorRate = emergencyErrorRate
currentCPM = emergencyCPM
end
end)
end)
