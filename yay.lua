...
BlacklistBtn.Position = UDim2.new(0, 15, 0, 145)
	...
	local success, err = pcall(function()
		if isCorrection then
			...
			if not accepted then
				...
				StatusText.Text = "Verification Passed"
...
runConn = RunService.RenderStepped:Connect(function()
	local success, err = pcall(function()
		...
		-- DETEKSI "Already Used!" dan tambahkan ke UsedWords
		...
		if typeVisible and not lastTypeVisible then
			...
			StatusText.TextColor3 = THEME.Success
			-- Clear cache usedwords tiap ronde baru
