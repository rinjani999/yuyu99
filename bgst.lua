...
local AutoBlatantBtn = CreateToggle("Auto Blatant: "..(autoBlatantMode and "ON" or "OFF"), UDim2.new(0, 15, 0, 143), function()
autoBlatantMode = not autoBlatantMode
Config.AutoBlatantMode = autoBlatantMode
return autoBlatantMode, "Auto Blatant: "..(autoBlatantMode and "ON" or "OFF"), autoBlatantMode and THEME.Success or Color3.fromRGB(255, 100, 100)
end)
AutoBlatantBtn.TextColor3 = autoBlatantMode and THEME.Success or Color3.fromRGB(255, 100, 100)
